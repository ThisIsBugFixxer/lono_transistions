...
public class CXEImagesToVideo: NSObject{
    ...
    public class func videoSettings(codec:String, width:Int, height:Int) -> [String: Any]{
        ...
        let videoSettings:[String: Any] = [AVVideoCodecKey: AVVideoCodecType.h264, AVVideoWidthKey: width, AVVideoHeightKey: height, AVVideoCompressionPropertiesKey: [AVVideoAverageBitRateKey: 100000000, AVVideoMaxKeyFrameIntervalKey: 1]]
    ...
    public init(videoSettings: [String: Any], firstFrameTime: Int = 0, frameTime: Int = 5) {
        super.init()
        ...
        self.frameTime = CMTimeMake(value: 1, timescale: Int32(frameTime))
        self.firstFrameTime = firstFrameTime
        self.lastFrameTime = CMTimeMake(value: 1, timescale: 2)
    }
